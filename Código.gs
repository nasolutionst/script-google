...
function aplicarEstiloVisualDocumento_(hoja) {
  ...
  const FUENTE = 'Aptos'; // si no te convence, cambia por 'Roboto'
  ...
  // Valores distribución del cobro
